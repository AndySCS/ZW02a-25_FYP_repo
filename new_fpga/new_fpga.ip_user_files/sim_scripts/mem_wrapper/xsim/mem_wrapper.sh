...
#
# Script generated by Vivado on Tue Apr 14 00:19:26 +0800 2026
...
#                mem_wrapper.sh [-rerun]
#                mem_wrapper.sh [-reset_run]
#                mem_wrapper.sh [-clean]
...
# script info
echo -e "mem_wrapper.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem_wrapper xil_defaultlib.mem_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mem_wrapper -key {Behavioral:sim_1:Functional:mem_wrapper} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem_wrapper.wdb xsim.dir libdpi.so)
...
Usage: mem_wrapper.sh [-rerun]\n\
Usage: mem_wrapper.sh [-reset_run]\n\
Usage: mem_wrapper.sh [-clean]\n\
