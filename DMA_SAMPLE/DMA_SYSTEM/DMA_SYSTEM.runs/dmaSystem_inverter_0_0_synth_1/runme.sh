...
HD_PWD='/dfs/usrhome/twipaa/Documents/uart/ZW02a-25_FYP_repo/DMA_SAMPLE/DMA_SYSTEM/DMA_SYSTEM.runs/dmaSystem_inverter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmaSystem_inverter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmaSystem_inverter_0_0.tcl
