...
HD_PWD='/dfs/usrhome/twipaa/Documents/uart/ZW02a-25_FYP_repo/DMA_SAMPLE/DMA_SYSTEM/DMA_SYSTEM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmaSystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmaSystem_wrapper.tcl -notrace
