...
HD_PWD='/dfs/usrhome/twipaa/Documents/big_ram/ZW02a-25_FYP_repo/FPGA/FPGA.runs/fpga_mem_wrapper_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_mem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_mem_wrapper.tcl
