...
#
# Script generated by Vivado on Wed Mar 11 22:05:36 HKT 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fpga_mem_wrapper.sh
...
#
# Usage        : fpga_mem_wrapper.sh
#                fpga_mem_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpga_mem_wrapper.sh [-reset_run]
#                fpga_mem_wrapper.sh [-reset_log]
#                fpga_mem_wrapper.sh [-help]
#
...
#                script (type 'fpga_mem_wrapper.sh -help' for more information).
#
...
# script info
echo -e "fpga_mem_wrapper.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpga_mem_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fpga_mem_wrapper xil_defaultlib.glbl -o fpga_mem_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fpga_mem_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fpga_mem_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fpga_mem_wrapper_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpga_mem_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpga_mem_wrapper.sh [-help]\n\
Usage: fpga_mem_wrapper.sh [-step]\n\
Usage: fpga_mem_wrapper.sh [-lib_map_path]\n\
Usage: fpga_mem_wrapper.sh [-reset_run]\n\
Usage: fpga_mem_wrapper.sh [-reset_log]\n\
Usage: fpga_mem_wrapper.sh [-keep_index]\n\
Usage: fpga_mem_wrapper.sh [-noclean_files]\n\n\
