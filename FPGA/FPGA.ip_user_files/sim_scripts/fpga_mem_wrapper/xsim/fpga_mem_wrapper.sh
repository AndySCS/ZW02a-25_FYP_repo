...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fpga_mem_wrapper xil_defaultlib.fpga_mem_wrapper xil_defaultlib.glbl -log elaborate.log
}
