...
#
# Script generated by Vivado on Tue Mar 17 15:51:14 HKT 2026
...
#                script (type 'fpga_ram_mem_wrapper.sh -help' for more information).
#
...
# script info
echo -e "fpga_ram_mem_wrapper.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fpga_ram_mem_wrapper xil_defaultlib.glbl -o fpga_ram_mem_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fpga_ram_mem_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/dfs/usrhome/twipaa/Documents/big_ram/ZW02a-25_FYP_repo/FPGA/FPGA.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fpga_ram_mem_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fpga_ram_mem_wrapper_simv.daidir vcs_lib c.obj)
