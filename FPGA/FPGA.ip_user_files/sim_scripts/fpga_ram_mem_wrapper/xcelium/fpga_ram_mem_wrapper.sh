...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fpga_ram_mem_wrapper xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fpga_ram_mem_wrapper -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/dfs/usrhome/twipaa/Documents/big_ram/ZW02a-25_FYP_repo/FPGA/FPGA.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fpga_ram_mem_wrapper_sc.so .tmp_log xcelium_lib waves.shm c.obj)
