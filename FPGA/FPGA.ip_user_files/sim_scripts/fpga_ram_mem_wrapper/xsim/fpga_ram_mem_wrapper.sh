...
#
# Script generated by Vivado on Thu Apr 09 20:16:35 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fpga_ram_mem_wrapper.sh
...
#
# Usage        : fpga_ram_mem_wrapper.sh
#                fpga_ram_mem_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fpga_ram_mem_wrapper.sh [-rerun]
#                fpga_ram_mem_wrapper.sh [-reset_run]
#                fpga_ram_mem_wrapper.sh [-clean]
#                fpga_ram_mem_wrapper.sh [-reset_log]
#                fpga_ram_mem_wrapper.sh [-help]
#
...
# script info
echo -e "fpga_ram_mem_wrapper.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fpga_ram_mem_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fpga_ram_mem_wrapper xil_defaultlib.fpga_ram_mem_wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fpga_ram_mem_wrapper -key {Behavioral:sim_1:Functional:fpga_ram_mem_wrapper} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fpga_ram_mem_wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fpga_ram_mem_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fpga_ram_mem_wrapper.sh [-help]\n\
Usage: fpga_ram_mem_wrapper.sh [-step]\n\
Usage: fpga_ram_mem_wrapper.sh [-lib_map_path]\n\
Usage: fpga_ram_mem_wrapper.sh [-rerun]\n\
Usage: fpga_ram_mem_wrapper.sh [-reset_run]\n\
Usage: fpga_ram_mem_wrapper.sh [-clean]\n\
Usage: fpga_ram_mem_wrapper.sh [-reset_log]\n\
Usage: fpga_ram_mem_wrapper.sh [-keep_index]\n\
Usage: fpga_ram_mem_wrapper.sh [-noclean_files]\n\n\
