...
#
# Script generated by Vivado on Sat Apr 04 23:58:08 HKT 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : extern_bram.sh
...
#
# Usage        : extern_bram.sh
#                extern_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                extern_bram.sh [-reset_run]
#                extern_bram.sh [-reset_log]
#                extern_bram.sh [-help]
#
...
#                script (type 'extern_bram.sh -help' for more information).
#
...
# script info
echo -e "extern_bram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./extern_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.extern_bram xil_defaultlib.glbl -o extern_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./extern_bram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key extern_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc extern_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./extern_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: extern_bram.sh [-help]\n\
Usage: extern_bram.sh [-step]\n\
Usage: extern_bram.sh [-lib_map_path]\n\
Usage: extern_bram.sh [-reset_run]\n\
Usage: extern_bram.sh [-reset_log]\n\
Usage: extern_bram.sh [-keep_index]\n\
Usage: extern_bram.sh [-noclean_files]\n\n\
