...
#
# Script generated by Vivado on Thu Apr 09 20:16:32 +0800 2026
...
#                extern_bram.sh [-rerun]
#                extern_bram.sh [-reset_run]
#                extern_bram.sh [-clean]
...
# script info
echo -e "extern_bram.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot extern_bram xil_defaultlib.extern_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim extern_bram -key {Behavioral:sim_1:Functional:extern_bram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb extern_bram.wdb xsim.dir libdpi.so)
...
Usage: extern_bram.sh [-rerun]\n\
Usage: extern_bram.sh [-reset_run]\n\
Usage: extern_bram.sh [-clean]\n\
