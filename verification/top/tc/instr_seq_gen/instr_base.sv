...
//ITYPE LOAD
class instr_ldtype extends instr_base;
    ...
    extern function pack();
    extern constraint ldtype_cons_opcode; 
endclass

function instr_ldtype::pack();
    instruction[6:0]   = instr_opcode;
    instruction[11:7]  = instr_rd;
    instruction[14:12] = instr_funct3;
    instruction[19:15] = instr_rs1;
...
constraint instr_ldtype::ldtype_cons_opcode{
    instr_opcode inside {7'b0000011};
    instr_funct3 inside {3'b000,
                         3'b001,
                         3'b010,
                         3'b100,
