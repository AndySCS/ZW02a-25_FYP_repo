module AXI_WRITE_INFT(
    ...
    assign axi_alloc_vld = lsu_axi_awvld_qual | axi_doing_st & AWREADY;
    ...
    assign axi_alloc_ptr_en = (|axi_alloc_en) & AWREADY;;
    ...
    assign wcnt_nxt = (lsu_axi_awvld_qual | wcnt_full) ? 8'b0 : wcnt + 7'b1;
