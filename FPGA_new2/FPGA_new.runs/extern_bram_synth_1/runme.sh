...
HD_PWD='/dfs/usrhome/twipaa/Documents/new_big_ram/ZW02a-25_FYP_repo/FPGA_new/FPGA_new.runs/extern_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log extern_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source extern_bram.tcl
