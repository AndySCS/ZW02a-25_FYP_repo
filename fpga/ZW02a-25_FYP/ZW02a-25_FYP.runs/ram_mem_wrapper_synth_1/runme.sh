...
HD_PWD='/dfs/usrhome/twipaa/Documents/fpga/ZW02a-25_FYP_repo/fpga/ZW02a-25_FYP/ZW02a-25_FYP.runs/ram_mem_wrapper_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_mem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_mem_wrapper.tcl
