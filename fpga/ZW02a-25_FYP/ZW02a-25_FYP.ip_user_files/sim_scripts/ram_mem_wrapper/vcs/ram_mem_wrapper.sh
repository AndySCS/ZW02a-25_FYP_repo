...
#
# Script generated by Vivado on Sun Mar 01 21:52:57 HKT 2026
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : ram_mem_wrapper.sh
...
#
# Usage        : ram_mem_wrapper.sh
#                ram_mem_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_mem_wrapper.sh [-reset_run]
#                ram_mem_wrapper.sh [-reset_log]
#                ram_mem_wrapper.sh [-help]
#
...
#                script (type 'ram_mem_wrapper.sh -help' for more information).
#
...
# script info
echo -e "ram_mem_wrapper.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_mem_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_mem_wrapper xil_defaultlib.glbl -o ram_mem_wrapper_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_mem_wrapper_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/dfs/usrhome/twipaa/Documents/fpga/ZW02a-25_FYP_repo/fpga/ZW02a-25_FYP/ZW02a-25_FYP.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ram_mem_wrapper_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_mem_wrapper_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_mem_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_mem_wrapper.sh [-help]\n\
Usage: ram_mem_wrapper.sh [-step]\n\
Usage: ram_mem_wrapper.sh [-lib_map_path]\n\
Usage: ram_mem_wrapper.sh [-reset_run]\n\
Usage: ram_mem_wrapper.sh [-reset_log]\n\
Usage: ram_mem_wrapper.sh [-keep_index]\n\
Usage: ram_mem_wrapper.sh [-noclean_files]\n\n\
